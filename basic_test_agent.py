"""
Basic Test para TDX Agent V2 - Sin emojis Unicode
...
def test_bant_scorer():
    ...
    result = bant_scorer.calculate_bant_score(good_prospect, "necesito urgente solucion")
...
def main():
    ...
    print("TDX Agent V2 - Basic Test Suite")
    print("=" * 50)
    ...
    if failed == 0:
        ...
        print(f"\nFAILED: {failed} tests failed. Please fix before deployment.")
